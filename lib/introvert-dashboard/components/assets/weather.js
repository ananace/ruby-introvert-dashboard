    ...
    .then(function(resp) {
      ...
      for (i in days) {
        ...
        var title = '<i style="font-size: 32pt; width: 4rem" class="text-center wi '+curdata.symbol+' mr-2"></i>\n'+
                    ...
                    '  <span class="text-white-50" style="font-size:9pt">'+data.average_day.temperature+'<i class="wi wi-celsius mr-1"></i>'+data.average_night.temperature+'<i class="wi wi-celsius"></i></span>\n'+
                    '</span>';
